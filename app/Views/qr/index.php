                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index-2.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="public/assets/images/icon.png" alt="" height="24"> <span class="logo-txt">Minia</span>
                                </span>
                            </a>
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="index-2.html" id="topnav-dashboard" role="button">
