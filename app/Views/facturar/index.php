...
<!-- Mirrored from themesbrand.com/minia/layouts/form-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Jun 2021 19:34:42 GMT -->
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Facturar</h4>
                                    ...
                                    <div class="card-body p-4">
                                        <form id="form-facturar">
                                            ...
                                            <div class="col-auto mt-3">
                                                <button type="submit" class="btn btn-primary">Facturar Todos</button>
                                            </div>
        ...
        <script src="<?= base_url() ?>/js/facturar.js"></script>
